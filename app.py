...
# MEM0 CLIENT
# =====================================================
MEMORY_USER_ID = "bharathtestcases01"
...
Include: user name, role, technical interests, tools, preferences, projects.
Exclude: passwords, API keys, financial data, government IDs, contact details.
